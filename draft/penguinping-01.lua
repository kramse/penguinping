...
function configure(parser)
	...
	parser:option("-s --baseport", "port"):default(-1):convert(tonumber)
	parser:option("-p --destport", "port"):default(80):convert(tonumber)
end
...
function master(args)
	...
	mg.startTask("loadSlave", dev:getTxQueue(0), args.spoof, args.host, args.baseport, args.destport)
	mg.waitForTasks()
end

function loadSlave(queue, minA, dest, baseport,  destport)
